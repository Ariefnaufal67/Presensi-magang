...
const MAKS_AKURASI_GPS = 150; // meter — di atas ini dianggap sinyal terlalu lemah/tidak bisa dipercaya
const BUFFER_AKURASI_MAKS = 30; // meter — toleransi tambahan dari radius kantor untuk imprecisi GPS wajar
